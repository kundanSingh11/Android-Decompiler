...
public class ProjectConstants {
	...
	// ".jar", ".dex");
	// public static final String JADX_LOCATION = "E:\\New
	// folder\\jadx-0.7.1\\bin\\jadx.bat";
	// public static final String JADX_AURGUMENTS = " -r -d %s -ds %s --deobf %s";
	// public static final String JAVA_PATH = "C:\\Program
	...
	public static final String JADX_LOCATION = "/home/kundan/jadx-0.7.1/bin/jadx";
	public static final String JADX_AURGUMENTS = " -r -d %s -ds %s --deobf %s";
	public static final String JAVA_PATH = "java";
	public static final String APKTOOL_JAR_PATH = "/home/kundan/jadx-0.7.1/apktool_2.3.3.jar";
	public static final String APKTOOL_AURGUMENTS = " d -s -f -o %s %s";
